...
import kotlinx.android.synthetic.main.activity_tv_menu.layout_main
import kotlinx.android.synthetic.main.activity_tv_menu.pb_tv_menu
import kotlinx.android.synthetic.main.activity_tv_menu.recycler_channels_list
import kotlinx.android.synthetic.main.activity_tv_menu.recycler_days_list
import kotlinx.android.synthetic.main.activity_tv_menu.recycler_groups_list
import kotlinx.android.synthetic.main.activity_tv_menu.recycler_programs_list
import timber.log.Timber
import javax.inject.Inject

class TVMenuActivity : AppCompatActivity(layout.activity_tv_menu), TVMenuContract.View
...
//    private val daysAdapter = DaysAdapter()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getTVMenuComponent(this).inject(this)
...
//        dayController.setData(list)
    ...
    override fun showNetworkErrorMessage(message: String) {
        Snackbar.make(layout_main, message, Snackbar.LENGTH_LONG).show()
        Timber.d(message)
    }

    override fun initGroupsRecycler() {
        recycler_groups_list.apply {
            layoutManager = LinearLayoutManager(this@TVMenuActivity, LinearLayoutManager.HORIZONTAL, false)
